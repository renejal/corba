...
abstract public class anteproyectoDTOHelper
{
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[3] = new org.omg.CORBA.StructMember (
            "atrNombreEstudiante1",
            _tcOf_members0,
            null);
          _tcOf_members0 = org.omg.CORBA.ORB.init ().create_string_tc (0);
          _members0[4] = new org.omg.CORBA.StructMember (
            "atrNombreEstudiante2",
            _tcOf_members0,
            null);
          _tcOf_members0 = org.omg.CORBA.ORB.init ().create_string_tc (0);
  ...
  public static sop_corba.anteproyectoDTO read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    value.atrNombreEstudiante1 = istream.read_string ();
    value.atrNombreEstudiante2 = istream.read_string ();
    value.atrNombreDirector = istream.read_string ();
    value.atrNombreCodirector = istream.read_string ();
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, sop_corba.anteproyectoDTO value)
  {
    ...
    ostream.write_string (value.atrNombreEstudiante1);
    ostream.write_string (value.atrNombreEstudiante2);
    ostream.write_string (value.atrNombreDirector);
    ostream.write_string (value.atrNombreCodirector);
